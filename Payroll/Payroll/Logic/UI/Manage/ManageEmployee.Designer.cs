...
partial class ManageEmployee
{
    ...
    private void InitializeComponent()
    {
        ...
        workHorus = new System.Windows.Forms.ColumnHeader();
        remove = new System.Windows.Forms.Button();
        contractType = new System.Windows.Forms.ColumnHeader();
        SuspendLayout();
        // 
        // listView1
        // 
        listView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] { ID, name, surname, workHorus, contractType });
        ...
        // surname
        // 
        surname.Name = "workHours";
        surname.Text = "Surname";
        surname.Width = 120;
        // 
        // workHorus
        // 
        workHorus.Name = "expectedSalary";
        workHorus.Text = "Work Hours";
        workHorus.Width = 120;
        // 
        // remove
        // 
        ...
        contractType.Text = "Contract Type";
        contractType.Width = 115;
        // 
        // ManageEmployee
        // 
    ...
    private System.Windows.Forms.ColumnHeader workHorus;
