...
public class Employee
{
    ...
    public Dictionary<string, PayHistory> PaymentHistory { get; set; } = new Dictionary<string, PayHistory>();

    public Employee() 
    { 
        if (PaymentHistory == null) PaymentHistory = new Dictionary<string, PayHistory>();
